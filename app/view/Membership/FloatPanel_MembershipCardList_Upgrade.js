                                            ...
                                            items: [
                                                {
                                                   ...
                                                   // store: 'MembershipCardCampaingEntitledLoadByMembershipCardCodeStore',
                                                    ...
                                                    //itemTpl: '<div class="myContent" style="background-color:transparent;height:87px">' +

                                                    //   '<div style="width:95%;text-align:right;margin:0px 0px 0px 0px;background-color: transparent;font-family:Arial, sans-serif;font-size:10px;font-weight:bold;color:black"><i>Stamp Loyalty Card</i></div>' +
                                                    //                                                                            '<br><div style="width:100%;text-align:right;margin:-30px 0px 0px 0px;background-color: transparent;font-family:Arial, sans-serif;font-size:10px;font-weight:bold;color:black"><img style="margin:-20px -10px 0px 0px;width:24px;height:24px;" src="{CampaignIcon}"></div>' +
                                                    //    '<br><div style="width:100%;text-align:center;margin:-48px 0px 0px 0px;background-color: transparent;font-family:Arial, sans-serif;font-size:12px;font-weight:bold;color:black"><img style="margin:-5px 0px 0px 0px;width:65px;height:65px;" src="resources/icons/StampSuccessBoxPresent.gif"></div>' +
                                                    //        '<br><div style="width:100%;text-align:center;margin:-33px 0px 0px 0px;background-color: transparent;font-family:Arial, sans-serif;font-size:14px;font-weight:bold;color:black">{CampaignName}</div>' +
                                                    //           '<br><div style="width:100%;text-align:center;margin:-25px 0px 0px 0px;background-color: transparent;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black">Start Date:{CampaignStartDate}</div>' +
                                                    //                                                       '<br><div style="width:100%;text-align:center;margin:-25px 0px 0px 0px;background-color: transparent;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black">End Date:{CampaignEndDate}</div>' +

                                                    //     '</div>',

                                                //    itemTpl: '<div class="myContent" style="background-color:transparent;height:150px">' +
                                                ...
                                                //        '<br><div style="width:100%;text-align:center;margin:-25px 0px 0px 0px;background-color: transparent;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black">Created Date:{CreatedDate}</div>' +
                                                //                                                    '<br><div style="width:100%;text-align:center;margin:-25px 0px 0px 0px;background-color: transparent;font-family:Arial, sans-serif;font-size:10px;font-weight:normal;color:black">Status:{RowStatus}</div>' +
...
function MoveMembeshipCarousel(Idx) {
    ...
    if (Idx == 0) {
        ...
        Ext.getCmp('btnFloatPanel_MembershipCardList_Upgrade_EntitiledReward').setHtml('<div style="width:100%;text-align:left;color:purple;font-family: Arial; font-size:13px;font-weight:bold;"><u>Membership Privillage</u></div>');
    ...
    if (Idx == 1) {
        ...
        Ext.getCmp('htmlUnsubscribeTxt').setHtml('<font size=1 color=grey>Unsubscribe</font>');
        Ext.getCmp('htmlMembershipCardTxt').setHtml('<font size=1 color=grey>Membership Card</font>');
        Ext.getCmp('btnFloatPanel_MembershipCardList_Upgrade_EntitiledReward').setHtml('<div style="width:100%;text-align:left;color:purple;font-family: Arial; font-size:13px;font-weight:bold;"><u>Membership Entitle Outlet</u></div>');
    ...
    if (Idx == 2) {
       ...
       // FloatPanel_MembershipCardList_Upgrade_LoyaltyStampLoadBySubscriberAccNoAndMembershipCardCodeStore(_FloatPanel_MembershipCardList_Upgrade_MembershipCode);
        ...
        Ext.getCmp('htmlUnsubscribeTxt').setHtml('<font size=1 color=grey>Unsubscribe</font>');
        Ext.getCmp('htmlMembershipCardTxt').setHtml('<font size=1 color=grey>Membership Card</font>');
        Ext.getCmp('btnFloatPanel_MembershipCardList_Upgrade_EntitiledReward').setHtml('<div style="width:100%;text-align:left;color:purple;font-family: Arial; font-size:13px;font-weight:bold;"><u>Membership Card Transaction</u></div>');
    }
    if (Idx == 3) {
        if (MembershipTag == 'NO') {
            return;
