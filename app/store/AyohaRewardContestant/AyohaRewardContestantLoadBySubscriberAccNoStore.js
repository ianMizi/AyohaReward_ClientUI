Ext.define('ianMizi.store.AyohaRewardContestant.AyohaRewardContestantLoadBySubscriberAccNoStore', {
    extend: 'Ext.data.Store',
    //  alias: 'store.ResponderAlertGetByAcc',
    config: {
        model: 'ianMizi.model.AyohaRewardContestant.AyohaRewardContestantModel',
        autoLoad: false,
