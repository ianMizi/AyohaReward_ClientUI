Ext.define('ianMizi.store.AyohaRewardPoint.AyohaRewardPointLoadBySubscriberAccNoEnterpriseAccNoMCCStore', {
    extend: 'Ext.data.Store',
    //  alias: 'store.ResponderAlertGetByAcc',
    config: {
        model: 'ianMizi.model.AyohaRewardPoint.AyohaRewardPointModel',
        autoLoad: false,
