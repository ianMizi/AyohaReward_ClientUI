...
Ext.define('Ext.event.publisher.TouchGesture', {
    ...
    onTouchStart: function(e) {
        ...
        if (isTouch) {
            target.addEventListener('touchmove', me.onTargetTouchMove, { passive: true });
            target.addEventListener('touchend', me.onTargetTouchEnd, { passive: true });
            target.addEventListener('touchcancel', me.onTargetTouchEnd, { passive: true });
        }
